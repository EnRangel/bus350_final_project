          ...
          <div className="row justify-content-center">
            <div className="col-md-4 mb-4">
              <div className="card" onClick={() => navigate('/food')}>
                <img
                    src="https://img.freepik.com/premium-vector/food-donation-meal-donates-vector-illustration_353502-460.jpg"
                    className="card-img-top" alt="Food"/>
            ...
            <div className="col-md-4 mb-4">
              <div className="card" onClick={() => navigate('/basic')}>
                <img src="https://www.shutterstock.com/image-vector/basic-needs-vector-icon-need-600nw-2302590675.jpg"
                     className="card-img-top" alt="Basic Needs"/>
                <div className="card-body">
            ...
            <div className="col-md-4 mb-4">
              <div className="card" onClick={() => navigate('/education')}>
                <img
                    src="https://www.cft.org/sites/main/files/imagecache/thumbnail/main-images/scholarship-application-portal_is-1220073028_0.png?1637609139"
                    className="card-img-top" alt="Education"/>
                <div className="card-body">
